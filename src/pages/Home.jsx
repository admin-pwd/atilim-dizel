  ...
  return (
    <div className="border-b border-slate-800">
      <button
        ...
        onClick={onClick}
      >
        <span className={`text-lg font-medium transition-colors ${isOpen ? 'text-orange-500' : 'text-slate-300 group-hover:text-white'}`}>
          {title}
        </span>
        <div
          className={`p-2 rounded-full transition-all duration-300 ${
            isOpen ? 'bg-orange-500/20 text-orange-500 rotate-180' : 'bg-slate-800 text-slate-400 group-hover:bg-slate-700'
          }`}
        >
      ...
      >
        <p className="text-slate-400 leading-relaxed pr-8 border-l-2 border-orange-500/30 pl-4 ml-1">{content}</p>
      </div>
    </div>
  );
}
...
function StepCard({ number, title, desc }) {
  return (
    <div className="relative p-6 border-l-2 border-slate-800 hover:border-orange-500 transition-colors pl-8 group">
      <span className="absolute -left-[9px] top-6 w-4 h-4 rounded-full bg-slate-800 group-hover:bg-orange-500 transition-colors border-2 border-slate-900" />
      ...
      <h4 className="text-xl font-bold text-white mb-2 group-hover:text-orange-400 transition-colors">{title}</h4>
    ...
    <>
      ...
      <div className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-slate-950">
        <div className="absolute inset-0 bg-slate-900">
          ...
          />
          <div className="absolute right-0 top-0 w-2/3 h-full bg-gradient-to-l from-orange-600/10 to-transparent blur-3xl" />
        ...
        <div className="container mx-auto px-4 relative z-10 pt-20">
          <div className="max-w-4xl mx-auto text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-900/30 border border-orange-500/30 text-orange-400 text-sm font-semibold mb-8 backdrop-blur-sm mx-auto md:mx-0">
              <CheckCircle size={16} className="text-orange-500" /> {"Trakya'nın Lider Dizel Servisi"}
            </div>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-tight mb-8 drop-shadow-2xl text-balance">
              {heroTitle.includes('\n')
                ? heroTitle.split('\n').map((line, i, arr) => (
                    <span key={i}>
                      {i === arr.length - 1 ? (
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-500 to-amber-500">{line}</span>
                      ) : (
                        <>{line}<br /></>
                      )}
                    </span>
                  ))
                : <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-500 to-amber-500">{heroTitle}</span>
              }
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button
                ...
                className="bg-orange-500 hover:bg-orange-400 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2 shadow-xl shadow-orange-500/20 hover:shadow-orange-500/40 hover:-translate-y-1 border border-orange-400/50"
              >
        ...
        <div className="absolute bottom-0 w-full bg-slate-900/60 backdrop-blur-md border-t border-white/5 py-8">
          <div className="container mx-auto px-4 flex justify-between items-center overflow-x-auto gap-12 opacity-60 hover:opacity-100 transition-all duration-500">
            {['BOSCH', 'DELPHI', 'SIEMENS', 'DENSO', 'VDO', 'CAT', 'CUMMINS'].map((brand) => (
              <span
                key={brand}
                className="text-xl md:text-2xl font-black text-slate-400 whitespace-nowrap hover:text-orange-400 transition-colors cursor-default tracking-tight"
              >
      ...
      <div className="py-20 bg-slate-900 border-b border-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-800/20 p-8 rounded-2xl border border-white/5 hover:bg-slate-800 hover:border-orange-500/30 transition-all group duration-300">
              <div className="mb-4 text-orange-500 group-hover:scale-110 transition-transform origin-left p-3 bg-orange-500/10 rounded-lg w-fit">
                <Wrench size={32} />
              </div>
      ...
      <div className="py-24 bg-slate-900 relative overflow-hidden">
        <div className="absolute left-0 top-0 w-1/3 h-full bg-orange-600/5 skew-x-12 transform -translate-x-1/2 blur-3xl" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <div className="text-4xl font-bold text-orange-500 mb-2">{item.num}</div>
            ...
            <div className="lg:w-1/2">
              <h2 className="text-orange-500 font-bold tracking-widest uppercase mb-4 text-sm flex items-center gap-2">
                <span className="w-8 h-1 bg-orange-500 rounded-full" /> KURUMSAL
              </h2>
              ...
              <button
                ...
                className="text-white border-b-2 border-orange-500 pb-1 hover:text-orange-500 transition-colors flex items-center gap-2 group"
              >
      ...
      <div className="py-24 bg-slate-950">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-orange-500 font-bold tracking-widest uppercase mb-3 text-sm">HİZMETLERİMİZ</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 text-balance">Neler Yapıyoruz?</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {displayServices.map((svc, i) => {
              ...
              return (
                <div
                  key={svc.title}
                  className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-white/5 p-0 rounded-2xl overflow-hidden hover:border-orange-500/50 transition-all group hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-900/20"
                >
                  ...
                  <div className="p-6">
                    <div className="w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center mb-4 group-hover:bg-orange-500 transition-colors border border-white/5">
                      <Icon className="text-orange-500 group-hover:text-white transition-colors" size={24} />
                    </div>
                    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-orange-400 transition-colors">{svc.title}</h3>
      ...
      <div className="py-24 bg-slate-900 border-t border-slate-800">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-br from-orange-900/40 via-slate-900/60 to-slate-900 rounded-[2rem] p-1 border border-orange-500/20 shadow-2xl">
            <div className="bg-slate-900/80 backdrop-blur-xl rounded-[1.9rem] p-8 md:p-12 relative overflow-hidden">
              <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-orange-600/20 rounded-full blur-[80px]" />
              <div className="grid lg:grid-cols-2 gap-12 relative z-10 items-center">
                <div>
                  <span className="inline-block py-1 px-4 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-sm font-bold mb-6">
                    <span className="flex items-center gap-2">
                      <Zap size={14} className="fill-orange-400" /> ÜCRETSİZ DANIŞMANLIK
                    </span>
                  </span>
                  <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight text-balance">
                    Hızlı Fiyat Teklifi <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400">15 Dakikada Cebinizde</span>
                  </h2>
                ...
                <div>
                  {quoteSubmitted ? (
                    <div className="bg-slate-800/50 backdrop-blur-md p-8 rounded-2xl border border-green-500/30 flex flex-col items-center justify-center min-h-[300px] text-center">
                    ...
                    <form onSubmit={handleQuoteSubmit} className="bg-slate-800/50 backdrop-blur-md p-8 rounded-2xl border border-white/5">
                      <div className="grid md:grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <input name="name" type="text" required className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl p-3.5 text-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-none" placeholder="Ahmet Yılmaz" />
                        </div>
                        <div>
                          <label className="block text-slate-400 text-sm mb-2 font-medium">Telefon Numaranız</label>
                          <input name="phone" type="tel" required className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl p-3.5 text-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-none" placeholder="05XX XXX XX XX" />
                        </div>
                      </div>
                      <div className="mb-4">
                        <label className="block text-slate-400 text-sm mb-2 font-medium">{"Araç Bilgisi / Şikayetiniz"}</label>
                        <textarea name="complaint" required className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl p-3.5 text-white focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-none h-24 resize-none" placeholder="Örn: Ford Transit 2018 - Siyah duman atıyor" />
                      </div>
                      <button type="submit" className="w-full bg-gradient-to-r from-orange-500 to-orange-400 hover:from-orange-400 hover:to-amber-400 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-orange-500/20 flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-1/3">
              <h2 className="text-orange-500 font-bold tracking-widest uppercase mb-3 text-sm">ÇALIŞMA SİSTEMİ</h2>
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 text-balance">Adım Adım Onarım Süreci</h3>
              <p className="text-slate-400 mb-8">Servisimize gelen her parça ve araç, standart bir kalite kontrol sürecinden geçer.</p>
              <button type="button" onClick={() => onNavigate('/iletisim')} className="bg-orange-500 hover:bg-orange-400 text-white px-6 py-3 rounded-xl font-bold transition-colors border border-orange-400/50 shadow-lg shadow-orange-500/20">
                Süreci Başlat
              </button>
            </div>
      ...
      <div className="py-24 bg-slate-950 relative overflow-hidden">
        <div className="absolute top-0 right-0 p-20 opacity-5">
          <MessageCircle size={400} className="text-orange-500" />
        </div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-orange-500 font-bold tracking-widest uppercase mb-3 text-sm">REFERANSLAR</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-white text-balance">Müşterilerimiz Ne Diyor?</h3>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {displayReviews.length > 0
              ? displayReviews.map((t, i) => (
                  <div key={i} className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800 hover:border-orange-500/30 transition-all hover:-translate-y-1">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center font-bold text-orange-500 border border-slate-700">
      ...
      <div className="py-24 bg-slate-900">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-12">
            <h2 className="text-orange-500 font-bold tracking-widest uppercase mb-3 text-sm">S.S.S</h2>
      ...
      {/* CTA */}
      <div className="py-20 bg-orange-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 text-balance">{"Aracınızın Performansını Riske Atmayın"}</h2>
          <p className="text-orange-100 text-lg md:text-xl mb-10 max-w-2xl mx-auto">{"Geç çalışma, duman atma veya yakıt sarfiyatı sorunlarınız mı var? Hemen ücretsiz ekspertiz için randevu alın."}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button type="button" onClick={() => onNavigate('/iletisim')} className="bg-white text-orange-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-100 transition-colors shadow-xl">
              Hemen Randevu Al
            </button>
            <a href={phoneHref} className="bg-orange-600 text-white border border-orange-400 px-8 py-4 rounded-xl font-bold text-lg hover:bg-orange-700 transition-colors flex items-center justify-center gap-2">
