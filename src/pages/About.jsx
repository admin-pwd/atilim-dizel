    ...
    <div className="pt-32 pb-20 min-h-screen bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-orange-500 font-bold tracking-widest uppercase mb-3 text-sm">HAKKIMIZDA</h2>
          <h3 className="text-4xl font-bold text-white mb-8 text-balance">{aboutTitle}</h3>
